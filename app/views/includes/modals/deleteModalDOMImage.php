      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header alert alert-danger">
            <h5 class="modal-title" id="deleteModalDOMImageLabel"><i class="fas fa-exclamation-triangle"></i><span> </span>Confimation: Delete DOM Image </h5>
          </div>
          <div class="modal-body">
            <p>Are you sure about Deleting this <i class='fa-solid fa-image'></i> item?</p>
